<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-50 transition-all">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <span class="font-bold text-xl text-indigo-600">VLMS</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->isAdmin())
                        ...
                        <x-nav-link :href="route('visitors.report')" :active="request()->routeIs('visitors.report')">
                            {{ __('Reports') }}
                        </x-nav-link>
